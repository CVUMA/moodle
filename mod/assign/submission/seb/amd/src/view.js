...
/**
 * Manage the assign views.
 *
 * @module     assignsubmission_seb/view
...
const TEMPLATE = {
    LOADING: 'assignsubmission_seb/loading',
};
...
export const showValidationFailedModal = () => {
    ModalAlert.create({
        title: Str.get_string('sebkeysvalidationfailed', 'assignsubmission_seb'),
        body: Str.get_string('invalidkeys', 'assignsubmission_seb'),
        large: false,
        show: true,
    }).catch(Notification.exception);
};
